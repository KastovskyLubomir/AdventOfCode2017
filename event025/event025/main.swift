...
var startState = States.A
var steps = 12481997


func turingMachine(state: States, steps: Int) -> Int {
    var tape = [Int](repeatElement(0, count: 100000))
    ...
    let sum = tape.reduce(0, +)
    return Int(sum)
}


print(turingMachine(state: startState, steps: steps))
